...
extension Reflect{
    ...
    func properties(_ property: (_ name: String, _ type: ReflectType, _ value: Any) -> Void){
    ...
    class func properties(_ property: (_ name: String, _ type: ReflectType, _ value: Any) -> Void){self.init().properties(property)}
}
